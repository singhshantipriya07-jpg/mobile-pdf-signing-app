...
app.post("/sign", upload.single("pdf"), async (req, res) => {
  ...
  const signatureDataUrl = req.body.signature; // Base64 signature image (optional)
  ...
  try {
    ...
    // Add a signature box with text - positioned at bottom right corner
    const margin = 30;
...
// Bind to 0.0.0.0 to accept connections from network devices
app.listen(5000, '0.0.0.0', () => {
  console.log("Server running on port 5000 (accessible from network)");
});
